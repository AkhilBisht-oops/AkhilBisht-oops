...
- 🔭 Working on real-world projects using **JavaScript**, **Python**, and **ML**
...
| ₿ [**Bitcoin Price Predictor**](https://github.com/AkhilBisht-oops/Bitcoin-Price-Predictor) | ML-based Bitcoin price prediction with real-time data, technical indicators & interactive charts | `Python` `Streamlit` `yfinance` |
...
![Profile Views](https://komarev.com/ghpvc/?username=AkhilBisht-oops&color=00d9ff&style=flat-square&label=Profile+Views)

*"The best way to get better at coding is to write more code."* 💡
